<script lang="ts">
	// Taken from the source, so I can expose the tab event
	// https://github.com/skeletonlabs/skeleton/blob/dev/packages/skeleton/src/lib/components/InputChip/InputChip.svelte
